...
経験的プロセスで重要なのは、成果に対する責任が見える化されていることだ。透明性とは、これらが標準化され、見ている人たちが共通理解を持つことである。
...
eduScrumでは、価値を高めることにフォーカスしている。価値とは、個人の学習結果、個人の成長、みんなの協力を総合したものである。eduScrumフレームワークは、上記の透明性を提供して、学習プロセスを支援するものである。透明性とは、学生が学習プロセスにおいて適切な決定を行い、価値を最大化するために必要なものである。
